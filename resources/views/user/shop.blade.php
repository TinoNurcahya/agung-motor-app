...
@section('content')
  ...
  <section class="relative pt-40 pb-20 bg-main overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 text-center space-y-4 relative z-10">
      <span class="inline-block px-4 py-1.5 rounded-full glass text-brand-primary text-xs font-bold uppercase tracking-widest">
        Spare Part Original
      </span>
      <h1 class="text-5xl md:text-7xl font-extrabold text-main reveal-text">Toko <span class="text-brand-primary">Spare Part</span></h1>
      <p class="text-gray-500 max-w-2xl mx-auto text-lg">Suku cadang original bergaransi. Order sekarang, siap pasang di bengkel kami.</p>
    </div>
  </section>
