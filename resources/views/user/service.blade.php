...
@section('content')
  ...
  <section class="relative pt-40 pb-20 bg-main overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 text-center space-y-4 relative z-10">
      ...
      <h1 class="text-5xl md:text-7xl font-extrabold text-main reveal-text">Semua Kebutuhan <br><span class="text-brand-primary">Motor</span> Anda
      </h1>
      <p class="text-muted max-w-2xl mx-auto text-lg">Dari servis ringan hingga overhaul mesin, mekanik profesional kami
        siap membantu.</p>
    </div>
  </section>

  <!-- ===== SERVICES GRID ===== -->
  <section class="py-16 md:py-24 bg-main" id="service-grid">
    <div class="max-w-7xl mx-auto px-6">
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <article class="glass-card p-8 group">
          ...
          <h3 class="text-xl font-bold mb-2 text-main">Service Rutin</h3>
          <p class="text-muted text-sm leading-relaxed mb-4">Ganti oli, filter udara, busi, dan pengecekan seluruh
        ...
        <article class="glass-card p-8 group">
          ...
          <h3 class="text-xl font-bold mb-2 text-main">Overhaul Mesin</h3>
          <p class="text-muted text-sm leading-relaxed mb-4">Bongkar total mesin, ganti ring piston, seal klep, dan
        ...
        <article class="glass-card p-8 group">
          ...
          <h3 class="text-xl font-bold mb-2 text-main">Servis Kelistrikan</h3>
          <p class="text-muted text-sm leading-relaxed mb-4">Perbaikan sistem pengapian, ganti aki, klakson, lampu LED,
        ...
        <article class="glass-card p-8 group">
          ...
          <h3 class="text-xl font-bold mb-2 text-main">Ganti Ban</h3>
          <p class="text-muted text-sm leading-relaxed mb-4">Ganti ban depan/belakang, spooring, balancing, dan tambal
            ban tubeless.</p>
        ...
        <article class="glass-card p-8 group">
          ...
          <h3 class="text-xl font-bold mb-2 text-main">Servis Rem</h3>
          <p class="text-muted text-sm leading-relaxed mb-4">Penggantian kampas rem, minyak rem, kalibrasi
        ...
        <article class="glass-card p-8 group">
          ...
          <h3 class="text-xl font-bold mb-2 text-main">Cat & Restorasi</h3>
          <p class="text-muted text-sm leading-relaxed mb-4">Pengecatan bodi motor, perbaikan baret, poles bodi, dan
