...
@section('content')
  <div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="glass-card p-8">
      {{-- action="{{ route('admin.pengeluaran.update', $pengeluaran->id) }}" method="POST" --}}
      <form class="space-y-6">
        ...
        <div>
          ...
          <input type="text" name="keterangan" value="Beli Oli Shell Advance (12 Pcs)"
            placeholder="Contoh: Beli Oli Shell Advance 12 Pcs"
            class="w-full bg-brand-surface border border-brand-primary/10 rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-expense focus:border-brand-expense outline-none">
        </div>
        ...
        <div>
          ...
          <select name="kategori"
            ...
            <option value="Stok Barang" selected>Stok Barang</option>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="number" name="nominal" value="650000" placeholder="0" min="0"
